...
Begin VB.Form RelDespFixa 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Relatório de despesas fixas"
   ClientHeight    =   1065
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7230
   Icon            =   "RelDespFixa.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
...
Private Sub cmdPrint_Click()
  ...
  'cmdPrint.Enabled = False-{LISTA_PROPRIETARIOS.NOME};crAscendingOrder;LISTA_PROPRIETARIOS|
  filtro = "{LISTA_DESP_FIXA.CONDOMINIO} = " & cpCodigo.Text
  RelatoriosRPT.Carregar "", Parametros.dados, filtro, "Despesas fixas do condomínio: " & cpNome.Text, sFormataCaminho(App.Path) & "despesafixa.rpt"
