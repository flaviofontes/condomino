...
Begin VB.Form RelAssociados 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Relatório de inquilinos"
   ClientHeight    =   1065
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7305
   Icon            =   "RelAssociados.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   End
End
Attribute VB_Name = "RelAssociados"
...
Private Sub cmdPrint_Click()
  ...
  filtro = "{LISTA_PROPRIETARIOS.CONDOMINIO} = " & cpCodigo.Text
  RelatoriosRPT.Carregar "", Parametros.dados, filtro, "Relatório de inquilinos", sFormataCaminho(App.Path) & "associados.rpt"
